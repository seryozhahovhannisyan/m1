...
public enum PartitionLCP {
    ...
    CONNECT_TO_TV               (1,  "connecttotv",         "connecttotv.com",  "https://www.connecttotv.com",  Language.ENGLISH),
    ...
    public static synchronized String getHost(int partitionId){
        return PartitionLCP.valueOf(partitionId) == null ? null : PartitionLCP.valueOf(partitionId).getHost();
    }
    ...
    public static synchronized boolean isVshoo(int partitionId){
        if( partitionId == VSHOO_USA.getId() || partitionId == VSHOO_LA.getId() || partitionId == VSHOO_ARMENIA.getId() || partitionId == VSHOO_ARMENIA_REGIONS.getId() || partitionId == VSHOO_YEREVAN.getId()){
            return true;
        }
        return false;
    }
