...
public class TransactionDepositProcessTax {
    ...
    public TransactionDepositProcessTax(Date actionDate, Long walletId, Long cashierCashBoxId, Double processTax, CurrencyType processTaxCurrencyType, TransactionTaxType processTaxType) {
    ...
    public TransactionDepositProcessTax(Date actionDate, Long walletId, Long cashierCashBoxId, Double processTax, CurrencyType processTaxCurrencyType, Double processTaxPrice, CurrencyType processTaxPriceCurrencyType, TransactionTaxType processTaxType, TransactionDepositExchange exchange) {
        this.actionDate = actionDate;
        this.walletId = walletId;
        this.cashierCashBoxId = cashierCashBoxId;
        this.processTax = processTax;
