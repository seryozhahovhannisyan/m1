...
<link href="<%=request.getContextPath()%>/mock/demo_files/datePicker/datePicker.css" rel="stylesheet"/>
<script type="text/javascript" src="<%=request.getContextPath()%>/libs/js/angular/isteven-multi-select.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/mock/demo_files/datePicker/ui-bootstrap-tpls-1.3.3.js"></script>
...
<div id="add" aria-hidden="true" role="dialog" tabindex="-1" class="modal fade in " style="display: none; padding-right: 17px;" ng-controller="branchesFormPhoneCodeCtrl as branchesFormPhoneCode" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog lg-modal " id="draggable_add">
                    ...
                    <form method="post" action="">
                        <div class="col-lg-10 add_modal_form_block">
                            ...
                            <div ng-controller="DatepickerPopupDemoCtrl">
                                <pre><s:text name="page.branches.modal.add.modal.datepicker.Selected.date.is">Selected date is:</s:text> <em>{{dt | date:'fullDate' }}</em></pre>
                                <div class="row">
                                    <div class="col-md-6">
                                        <p class="input-group">
