...
<div ng-controller="mainContentCtrl as mainContent">
    <div class="main_header">
        ...
        <div class="main-under-heading-text col-lg-4 cole-sm-4">
            <s:text name="page.home.heading.content">With the help of this site you can easily turn cash into online money and online money into cash.
                By having money on your account you can spend it as you wish, as well as you can transfer money to your friends'
                accounts and even get some bonuses.  You may feel quite comfortable with Merchant as it provides 100% protection and security.
            </s:text>
        </div>
    ...
    <div class="main_first_block">
        ...
        <div class="first_block_content_margin col-lg-4 col-md-4 col-sm-4 col-xs-12">
            <div class="first_block_title">
                <s:text name="page.main.first.block.title">Two in one</s:text>
            </div>
            <div class="first_block_text">
                <s:text name="page.main.first.block.text">The processes of Merchant are closely connected with those of ConnectToWallet.
                    Thus with help of Merchant you may accomplish some actions in ConnectToWallet as well.</s:text>
            </div>
        </div>
    </div>
    ...
    <div class="main_second_block">
        ...
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
            <div class="second_block_title">
                <s:text name="page.main.second.block.title">Accessible anywhere and for everyone.</s:text>
            </div>
            <div class="second_block_text">
                <s:text name="page.main.second.block.text">You can upload this application on your computers, IPads and cell phones. The application is
                    reachable anywhere and for everyone, thus you may make use of it whenever you want.</s:text>
            </div>
        </div>
        <div class="go_to_top">
    ...
    <div class="main_third_block" ng-controller="profileFormValidateCtrl as profileFormValidate">
        ...
        <div class="main_request_form_block_heading_text col-lg-4 col-sm-4" id="main_request_form_block_heading_text">
            <h3><s:text name="page.main.third.block.heading.text">Fill the following list and press the button "Send the request form".
                After considering the information you provided, we will inform you about our decision.</s:text></h3>
        </div>
        <div class="col-lg-3 col-md-6 col-sm-8 col-xs-12 main_request_form_block">
            ...
            <form id="rf" name="mainRequestForm" action="do-company-form-request.htm" method="post" ng-submit='profileFormValidate.submit(mainRequestForm)' novalidate="novalidate">
                ...
                <div class="main-request-form">
                    ...
                    <div class="resend_act_code">
                        <p ng-click="ctrl.open('null','','resend_activation_code')"><s:text name="page.main.resend.activation">Resend activation code</s:text></p>
                    </div>
