...
<link rel = "stylesheet" href = "<%=request.getContextPath()%>/css/branch/branch_add.css">
...
<script type = "text/javascript" src = "<%=request.getContextPath()%>/js/branches/add_new_branch.js"></script>
        ...
        <div class = "col-md-12 col-sm-12 col-xs-12" ng-controller = "addBranchtCtrl">
            ...
            <div class = "modal-body">
                <div class = "add_modal_form_block" ng-controller = "branchIstevenCtrl">
                    <form method = "post" action = "branch-add.htm" name = "branchActivationForm" novalidate ng-init="renderRecaptcha()" ng-submit="submity('branchActivationForm')">
                        ...
                        <section class = "section1 animate-show-hide" ng-show = "section1">
                            <div class = "form_div_conteiner">
                                ...
                                <div>
                                    <input type = "text" class = "company_name_input" name = "name"
                                           ng-model = "branch.nameBranch"
                            ...
                            <s:text name = "page.main.third.block.message.required">Required!</s:text>
                                ...
                                <div>
                                    <input type = "text" class = "company_addres_input" name = "address"
                                           ng-model = "branch.addressBranch"
                             ...
                             <s:text name = "page.main.third.block.message.required">Required!</s:text>
                                ...
                                <div>
                                    <input type = "text" class = "company_city_input" name = "city"
                                           ng-model = "branch.cityBranch"
                            ...
                            <s:text name = "page.main.third.block.message.required">Required!</s:text>
                                ...
                                <div>
                                    <input type = "text" class = "company_street_input" name = "street"
                                           ng-model = "branch.streetBranch"
                            ...
                            <s:text name = "page.main.third.block.message.required">Required!</s:text>
                                ...
                                <div>
                                    <input type = "text" class = "company_zipcode_input" name = "zip"
                                           ng-model = "branch.zipBranch"
                            ...
                            <s:text name = "page.main.third.block.message.required">Required!</s:text>
                                ...
                                <div>
                                    <input type = "email" class = "company_email_input" name = "email"
                                           ng-model = "branch.emailBranch"
                    ...
                    <s:text name = "page.main.third.block.message.required">Required!</s:text>
                                    ...
                                    <span class = "input_error" ng-cloak
                                          ng-show = "branchActivationForm.email.$touched && branchActivationForm.email.$error.pattern">
                    <s:text name = "page.main.third.block.message.email.invalid">Your email address is invalid!</s:text>
                                ...
                                <div class = "ist_mult_parent">
                                    <isteven-multi-select class = "ist_mult  ist_mult_branch_phone_code "
                                         data-branchPhoneCode = {{branchPhoneCode}}
                                    ...
                                    <input type = "hidden" name = "phoneCode" ng-value = "branchPhoneCode"/>
                                    <input type = "text" class = "company_phone_input" name = "phone"
                                           ng-model = "branch.phoneBranch"
                            ...
                            <s:text name = "page.main.third.block.message.required">Required!</s:text>
                                ...
                                <div class = "ist_mult_parent">
                                    <isteven-multi-select class = "ist_mult ist_mult_branch_policy_code"
                                         data-branchPolicyCode = {{branchPolicyCode}}
                                    ...
                                    <input type = "hidden" name = "policyPhoneCode"
                                           ng-value = "branchPolicyCode"/>
                                    <input type = "text" class = "company_policphone_input" name = "policyPhone"
                            ...
                            <s:text name = "page.main.third.block.message.required">Required!</s:text>
                                ...
                                <div style = "height:40px">
                                    <div class = "ist_mult_parent">
                                        ...
                                        <isteven-multi-select class = "ist_mult list_mult_regiont_branch "
                                        data-branchRegions = {{branchRegion}}
                                        ...
                                        <input type="hidden" name="region" ng-value="branchRegion"/>
                                    </div>
                                ...
                                <%--</span>--%>
<div>
                                <button type="button" class = "btn btn-block btn-info"  ng-click = "uiSerfBranch()"
                                   ng-disabled="branchActivationForm.email.$error.pattern">
                        ...
                        <section class = "section2 animate-show-hide" ng-show = "section2">
                            ...
                            <div>
                                <div class = "company_upload_parent">
                                    <h1><s:text
                                            name = "page.home.company.request.upload.branch.logo">Upload Branch Logo</s:text></h1>
                                    <div class = "company_upload_inpar">

                                        <label for = "branch_logo" class = "first_label"
                                               style = "background-image: url({{branch_img}})">
                                            <input type = "file" data-file = "branch" data-img_url= "branch_img" data-scope_name= "branch_scope" id = "branch_logo"
                            ...
                            <button  type="button" class = "btn btn-block btn-info" ng-click = "backBranch()">
                                <s:text name="page.home.placeholder.company.request.form.back">Back</s:text>
                                &nbsp
                                <i class="fa fa-hand-o-left" aria-hidden="true"></i>
                            </button>
                            <button  type="button" class = "btn btn-block btn-info" ng-click = "toCashier()">
                                <s:text name = "page.home.placeholder.company.request.form.next">Next</s:text>
                                &nbsp
                                <i class = "fa fa-hand-o-right" aria-hidden = "true"></i>
                            </button>
                    ...
                    <s:text name = "page.main.third.block.message.required">Required!</s:text>
                        ...
                        <section class = "section5   animate-show-hide" ng-show="section5" >
                            <div class = "form_div_conteiner">
                        ...
                        <section class="section6    animate-show-hide" ng-show="section6" >
                    ...
                    <s:text name="page.main.third.block.message.required">Required!</s:text>
                                ...
                                <div>
                                    <button type="button"   class="btn btn-block btn-info" ng-click ="backRole()">
                                        <s:text name="page.home.placeholder.company.request.form.back">Back</s:text>
                                        &nbsp
                                        <i class="fa fa-hand-o-left" aria-hidden="true"></i>
                                    </button>
