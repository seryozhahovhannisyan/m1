(function($angular) {
    ...
    //  $angular.module('dropletApp', ['ngDroplet']).controller('IndexController', function IndexController($scope, $timeout) {
        controllers.IndexController = function ($scope, $timeout) {
        /**
         * @property interface
         * @type {Object}
         */
        ...
        $scope.$on('$dropletReady', function whenDropletReady() {
            ...
            $scope.interface.allowedExtensions(['png', 'jpg', 'bmp', 'gif', 'svg','txt', 'pdf']);
    ...
    mainApp.directive('progressbar', function ProgressbarDirective() {
