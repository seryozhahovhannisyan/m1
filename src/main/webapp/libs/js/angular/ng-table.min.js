...
!function (a, b) {
            ...
            this.data = [], this.parameters = function (b, c) {
                if (c = c || !1, a.isDefined(b)) {
                    for (var e in b) {
                        ...
                        } else i[e] = d(b[e]) ? parseFloat(b[e]) : b[e]
                    }
                ...
                return a.isDefined(b) ? this.parameters({count: b, page: 1}) : i.count
                ...
                var a = [];
                for (var b in i.sorting)a.push(("asc" === i.sorting[b] ? "+" : "-") + b);
                return a
            }, this.getData = function (b, c) {
                b.resolve(a.isArray(this.data) && a.isObject(c) ? this.data.slice((c.page() - 1) * c.count(), c.page() * c.count()) : [])
                ...
                if (d = 11, i = [], h = Math.ceil(b / c), h > 1) {
                    ...
                    for (var j = g; e >= j;)i.push(j === g && 2 !== j || j === e && j !== h - 1 ? {
                        type: "more",
                        active: !1
                    } : {type: "page", number: j, active: a !== j}), j++;
                    i.push({type: "last", number: h, active: a !== h}), i.push({
                        type: "next",
                ...
                j.$loading = !0, j.groupBy ? j.getGroups(a, j.groupBy, this) : j.getData(a, this), h("ngTable: reload data"), a.promise.then(function (a) {
                    j.$loading = !1, h("ngTable: current scope", j.$scope), c.data = j.groupBy ? j.$scope.$groups = a : j.$scope.$data = a, j.$scope.pages = c.generatePagesArray(c.page(), c.total(), c.count())
                })
    ...
    var c = ["$scope", "ngTableParams", "$q", function (b, c) {
        ...
        b.$watch("params.$params", function (c, e) {
            b.params.settings().$scope = b, a.equals(c.filter, e.filter) ? b.params.reload() : d(function () {
                b.params.reload()
            }, b.params.settings().filterDelay)
        }, !0), b.sortBy = function (a, c) {
            var d = b.parse(a.sortable);
            if (d) {
                var e = b.params.settings().defaultSort, f = "asc" === e ? "desc" : "asc", g = b.params.sorting() && b.params.sorting()[d] && b.params.sorting()[d] === e, h = c.ctrlKey ? b.params.sorting() : {};
    ...
    return b.directive("ngTable", ["$compile", "$q", "$parse", function (b, d, e) {
        return {
            restrict: "A", priority: 1001, scope: !0, controller: c, compile: function (c) {
                ...
                return a.forEach(a.element(c.find("tr")), function (b) {
                    ...
                    if (c.$loading = !1, c.$columns = d, c.$watch(g.ngTable, function (b) {
                        ...
                        return f.prepend(i), b(i)(c), b(j)(c), f.addClass("ng-table"), f.after(j)
                    }
                }) : void 0
            }
        }
